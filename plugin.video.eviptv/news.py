...
summary=gAI('summary'); 	
artPath=xbmc.translatePath(os.path.join(addon_path,'resources/art'))
## ################################################## ##
## ################################################## ##
...
DefaultSplitter="|||"; 
DefaultUrl="http://theplayersklub.co.com/news/news.txt"; 
class MyWindow(xbmcgui.WindowDialog): #xbmcgui.Window): ##xbmcgui.Window
	scr={}; scr['L']=0; scr['T']=0; scr['W']=1280; scr['H']=720; 
	def __init__(self,noteType='t',noteMessage='',noteImage='',L=140,T=110,W=1000,H=500,Font='font15',TxtColor='0xFF64d1ff'):
