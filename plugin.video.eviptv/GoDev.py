...
ADDON=xbmcaddon.Addon(id='plugin.video.eviptv')
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.eviptv/speedtest.py")') ###############
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.eviptv/fastload.py")')  ###############
...
def iVueInt():
	...
	AddoniVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.eviptv/resources','ivueset.xml')) ###############
	...
	xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.eviptv/fullivue.py")') ###############
