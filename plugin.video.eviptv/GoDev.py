...
FabAddon = xbmcaddon.Addon('plugin.video.eviptv')
ADDON=xbmcaddon.Addon(id='plugin.video.eviptv')
dialog       =  xbmcgui.Dialog()
dialogprocess =  xbmcgui.DialogProgress()
USERDATA     =  xbmc.translatePath(os.path.join('special://home/userdata/',''))
FabData      =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.eviptv/',''))
...
def SpeedChoice():
	...
	if choice == 0:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.playklub/speedtest.py")')
	if choice == 1:
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.playklub/fastload.py")')
